...
namespace LP.WXK.K3.Common.Utils
{
    ...
    public static class RsaKeyConverter
    {
        ...
        /// RSA私钥格式转换：Java -> .NET
        /// </summary>
        /// <param name="privateKey">Java生成的RSA私钥（Base64编码）</param>
        /// <returns>.NET格式的RSA私钥（XML格式）</returns>
        ...
        /// RSA私钥格式转换：.NET -> Java
        /// </summary>
        /// <param name="privateKey">.NET生成的私钥（XML格式）</param>
        /// <returns>Java格式的RSA私钥（Base64编码）</returns>
        ...
        /// RSA公钥格式转换：Java -> .NET
        /// </summary>
        /// <param name="publicKey">Java生成的公钥（Base64编码）</param>
        /// <returns>.NET格式的RSA公钥（XML格式）</returns>
        ...
        /// RSA公钥格式转换：.NET -> Java
        /// </summary>
        /// <param name="publicKey">.NET生成的公钥（XML格式）</param>
        /// <returns>Java格式的RSA公钥（Base64编码）</returns>
        ...
        public static string RsaEncrypt(string xmlPublicKey, string plainText)
        {
            try
            {
                ...
                plainTextBArray = (new UTF8Encoding()).GetBytes(plainText);
