    ...
    public class PaymentRequestBillServicePlugIn : AbstractBillPlugIn
    {
        public override void ButtonClick(ButtonClickEventArgs e)
        {
            if (e.Key == "F_ZKYD_OALINK")
            {
                ...
                /*;"*/
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("http://oa.wxkpharma.com/ssologin/getToken?");
                            ...
                            if (ReqInfo != "" && ReqInfo != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (OANumber != null && OANumber != "")
                                    {
                                        ...
                                        string url = "http://oa.wxkpharma.com/spa/workflow/index_form.jsp?ssoToken=" + ReqInfo + "#/main/workflow/req?requestid=" + requestId.ToString();
